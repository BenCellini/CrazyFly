classdef head_roll_tracker
    %% head_roll_tracker: tracks head yaw and roll
    %
    ...
    properties %(SetAccess = private)
        ...
        head_iso_vid        % isolated head in yaw stabilized head video
        head_iso_props      % isolated video properties
    ...
    methods
        function obj = head_roll_tracker(vid, roll_cal)
            % head_roll_tracker: Construct an instance of this class
            %   
            ...
            [obj.vid_props, obj.bw_vid, obj.bound_box, obj.body_yaw] = get_vid_props(obj, obj.vid, [], false);
            ...
            % Get roll
            [~, obj] = get_roll(obj, 0.35, roll_cal, false);
        end
