function [norm_ang,imgstats,initframe] = bodytracker_net(vid, playback, head_debug, par)
%% bodytracker_net: tracks the body angle of an insect in a magnetic tether. 
% Uses neural network to detect the correct heading.
%
...
[~, ~, flip] = getheading(vid(:,:,1), 0.6, showplot, NN)
disp('Heading found.')
